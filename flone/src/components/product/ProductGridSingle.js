...
const ProductGridSingle = ({
    ...
    const finalDiscountedPrice = product.discountPrice;
    //alert(JSON.stringify(process.env.REACT_APP_BACKEND_URL+product.image[2]))
    return (
        <Fragment>
                            ...
                            {product.image && product.image.length > 0 ? (
                                <>
                                    ...
                                    {product.image.length > 1 ? (
                                        <img
                                            className="hover-img"
                                            src={`${process.env.REACT_APP_BACKEND_URL}${product.image[1]}`}
